...
from dino_runner.utils.constants import HAMMER_TYPE, SHIELD_TYPE, DEFAULT_TYPE, RUNNING, JUMPING, DUCKING, DUCKING_SHIELD, RUNNING_SHIELD, JUMPING_SHIELD, RUNNING_HAMMER, DUCKING_HAMMER, JUMPING_HAMMER
